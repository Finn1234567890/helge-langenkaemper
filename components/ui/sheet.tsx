  ...
  <SheetPortal>
    ...
    >
      ...
      <SheetPrimitive.Close className="absolute right-8 top-8 transition-opacity ">
        <IoMdClose className="text-5xl hover:rotate-90 transition-all duration-300 ease-in-out !focus:outline-none !focus:border-0 !hover:border-none !hover:outline-none !border-none !outline-none text-accent" />
